...
#инициализируем бота
TOKEN = "6005884016:AAEWegzDFQGdzfWrcn_mGWiOm8cS64nBei0"
bot = Bot(token=TOKEN)
...
async def start(message : types.Message):
	...
	button_start = KeyboardButton('А ты готов знакомиться?')
...
@dp.message_handler(lambda message: message.text == 'Зайти в волшебный мир DatITMO' or message.text == '/magic_start',state='*')
